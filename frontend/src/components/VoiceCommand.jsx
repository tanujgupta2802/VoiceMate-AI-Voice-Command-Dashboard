...
//                   .trim();
//                 playMusic(videoId, songName || "Music");
//               } else {
...
//       {currentMusic && (
//         <div className="fixed bottom-8 right-8 z-50 bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-violet-500/50 rounded-3xl p-6 shadow-2xl shadow-violet-500/30 w-80 animate-slideUp">
//           <div className="flex items-center gap-4 mb-4">
//             <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 flex items-center justify-center animate-pulse">
...
//               className="w-14 h-14 rounded-full bg-gradient-to-br from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 flex items-center justify-center transition-all transform hover:scale-110 shadow-lg"
...
//                   isPlaying ? "animate-musicBar" : "h-2"
//                 }`}
//                 style={{
...
//           )}
//         </div>
//         <p className="text-slate-400 text-sm sm:text-[13px] font-medium mb-4">
//           Your intelligent voice assistant
//         </p>

//         {/* ✅ NEW: Feature Showcase Cards */}
...
//           <p className="text-slate-400 font-medium text-sm sm:text-[13px] mb-2">
//             Set your thoughts and remainders as notes
//           </p>
//           <p className="text-blue-400 font-medium text-sm sm:text-[14px] mb-7">
//             To create a note, say "Create note..." Example: Create note 5:00 PM
//             meeting today.
//           </p>
    ...
    if (action === "play") {
      if (playerRef.current && playerRef.current.getPlayerState) {
        ...
        if (state === 2) {
          ...
          initializePlayer(musicMsg.videoId, messageId);
        }
      } else {
        initializePlayer(musicMsg.videoId, messageId);
      }
                              ...
                              <div className="flex items-center justify-center gap-3">
                                <button
                                  onClick={() =>
                                    handleMusicControl(
                                      msg.id,
                                      msg.isPlaying ? "pause" : "play"
                                    )
                                  }
                                  className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 flex items-center justify-center transition-all transform hover:scale-110 shadow-lg"
